...
const ContactForm = () => {
  ...
  return (
    <div className='flex justify-center items-center h-screen'>
      <form
        className='w-full max-w-md bg-blue-950 rounded-lg p-8'
      ...
      >
        ...
        <div className='mb-4'>
            <label className='block text-white text-md font-bold mb-2' htmlFor="comment">
                Questions & Comments
            </label>
            <textarea
                className='w-full px-3 py-2 border border-gray-300 rounded-md'
        ...
        <div className='mb-4'>
            <label className='flex items-center'>
                ...
                />
                <span className='ml-2 text-white text-sm'>Recieve marketing and offer emails</span>
            </label>
        </div>
        <button
      ...
      {submit && (
        <div className='fixed inset-0 flex items-center justify-center'>
          <div className='absolute inset-0 bg0black opacity-50'></div>
            <div className='bg-white relative rounded-lg p-8 z-10'>
